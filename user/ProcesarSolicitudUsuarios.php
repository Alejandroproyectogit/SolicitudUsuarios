...
/* Obtenemos los datos que se nos envian del archivo "formularioSolicitudUsuarios.php" */
...
if (
    ...
    /* Usamos un foreach para insertar un registro por cada sistema que se haya seleccionado */
