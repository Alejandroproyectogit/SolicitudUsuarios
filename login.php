        ...
        <div class="app-auth-container">
            ...
            <form action="index.php?accion=validarCredenciales" method="POST">
                <div class="auth-credentials m-b-xxl">
                    <label for="signInEmail" class="form-label">Usuario</label>
                    <input type="text" class="form-control m-b-md" id="signInEmail" name="usuario" aria-describedby="signInEmail" placeholder="Ingresa Tu Usuario" required>

                    <label for="signInPassword" class="form-label">Contraseña</label>
                    <input type="password" class="form-control" id="signInPassword" name="pass" aria-describedby="signInPassword" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;" required>
                </div>
